...
# -*- coding: utf-8 -*-
"""
Created on Sun May 31 08:49:31 2020
...
#bundle_diversity_map=pickle.load(io.open('../data/processed_data/bundle_diversity_map',"rb"))


all_items =pickle.load(open('../data/processed_data/all_items','rb'))
item_name =pickle.load(open('../data/processed_data/item_name_map','rb'))
